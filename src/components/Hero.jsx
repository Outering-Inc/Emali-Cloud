...
import { discount,hero_left } from '../assets';
...
const Hero = () =>  (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} ${styles.heroSection}`}>
      ...
      <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-3 mt-20`}>
            <span className="text-white"> Get 30 days </span> Free trial {" "}
            <span className="text-white">No Credit Card</span> Required
          </p>
        </div>
        <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold ss:text-[60px] text-[20px] text-white ss:leading-[50px] leading-[15px]">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5 `}>
         Just Cloud your Business workflow with Emali Cloud.
        </p>
      </div>
