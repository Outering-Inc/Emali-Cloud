...
const createElm = (e, t, a, o) => {
 ...
 l["s-cr"] = contentRef, l["s-sn"] = n.$name$ || "", l["s-rf"] = null === (s = n.$attrs$) || void 0 === s ? void 0 : s.ref, 
 i = e && e.$children$ && e.$children$[a], i && i.$tag$ === n.$tag$ && e.$elm$ && (appData.BUILD.experimentalSlotFixes ? relocateToHostRoot(e.$elm$) : putBackInOriginalLocation(e.$elm$, !1))), 
 l;
 ...
 if (e["s-sr"] && appData.BUILD.experimentalSlotFixes) {
  let t = e;
  for (;t = t.nextSibling; ) t && t["s-sn"] === e["s-sn"] && t["s-sh"] === hostTagName && a.push(t);
 }
...
const callRender = (e, t, a, o) => {
 ...
 e.cloneNode = function(e) {
  ...
  if (appData.BUILD.slot && !o && e) {
   let e, t, o = 0;
   const n = [ "s-id", "s-cr", "s-lr", "s-rc", "s-sc", "s-p", "s-cn", "s-sr", "s-sn", "s-hn", "s-ol", "s-nr", "s-si", "s-rf" ];
